...
let BookingEight = require('../models/booking.eight.model');
...
router.route('/add').post((req, res) => {
    ...
    const newBooking = new BookingEight({
        name: req.body.name,
    ...
    newBooking.save()
        .then((r) => {
            ...
            let mailDetails = {
                ...
                subject: 'New Reservation 1988 Lounge and Bar',
                html: "<div>" +
                    "<p>" + "1988 Lounge + Bar" + "</p>" +
...
router.route('/delete/:id').post((req, res) => {
    ...
    BookingEight.findByIdAndUpdate(req.params.id, { deleted: req.body.delete || false })
...
router.route('/update/:id').post((req, res) => {
    ...
    BookingEight.findByIdAndUpdate(req.params.id, req.body).then((r) => res.json(`${req.params.id} updated`))
        .catch((e) => {
